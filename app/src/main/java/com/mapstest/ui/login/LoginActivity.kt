...
import com.mapstest.MapsActivity
import com.example.mapstest.databinding.ActivityLoginBinding
...
import com.mapstest.MapViewModel
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun updateUiWithUser(result: Result) {
        val welcome = getString(R.string.welcome)
        val displayName = result.user.userName
        ...
        lifecycleScope.launch {
            repeatOnLifecycle(Lifecycle.State.STARTED){
                viewModel.uiState.collect{
                    it.copy(result.artists, result.user)
                }
            }
        }
        */
